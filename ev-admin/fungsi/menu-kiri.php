...
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="nav-link collapsed" href="?hal=member-filter&mau=admin">
...
<li class="nav-item">
  ...
  <div id="kontak_kami" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="?hal=kontak-data&mau=tampil"><i class="fas fa-envelope-open-text    "></i> Pesan Ditampilkan</a>
      <a class="collapse-item" href="?hal=kontak-data&mau=belum"><i class="fa fa-envelope-open" aria-hidden="true"></i> Belum ditampilkan</a>
    </div>
  </div>
</li>
