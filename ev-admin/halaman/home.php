                    ...
                    // $tampilin = $isi->tampilData("user");
                        ...
                        foreach($perintah as $a)
                        {
                            ...
                            else 
                            {
                                ...
                                $gambar = 
                                "   <a data-fancybox='Event - $nama' href='$tujuan' data-caption='$nama'>
                                        <img src='$tujuan' width='50' height='50'>
                                    </a>
                                ";
                                $UserFoto = 
                                "   <a data-fancybox='$nama' href='$goalUser' data-caption='$autor - $nama'>
                     ...
                     <?php
                        ...
                        $tampilin = $isi->tampilData("paket_member");
                            ...
                            foreach($tampilin as $a)
                            {
                                ...
                                echo
                                "
                                <div class='card mb-3' style='width: 100%; font-size:12px;'>
                                    <div class='row g-0'>
                                    <div class='col-md-5'>
                                        $box
                                    </div>
