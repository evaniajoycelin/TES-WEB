<?php
    ...
    if ($mau=='tambah') 
    {
        ...
        if (!empty($fotonm)) 
        {
            ...
            $isian     = "NULL, '$nama', '$desk', '$newe', '$simpan'";
        } 
        else 
        {
            $isian     = "NULL, '$nama', '$desk', 'Kosong', '$simpan'";
        }
    ...
    else
    {
        ...
        if (!empty($fotonm)) 
        {
            ...
            $isian     = "nama_kelas='$nama', deskripsi='$desk', foto_kelas='$newe', kondisi='$simpan'";
        } 
        else 
        {
            //$isian     = "NULL, '$nama', '$tgl', '$desk', 'Kosong', '$idUser'";
            $isian = "nama_kelas='$nama', deskripsi='$desk', kondisi='$simpan'";
        }
