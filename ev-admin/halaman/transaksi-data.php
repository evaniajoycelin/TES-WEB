                           ...
                           foreach ($perintah as $key) 
                           {
                               ...
                               else
                               {
                                   ...
                                   if ($hitungPaket==0) 
                                   {
                                       ...
                                       $tombolHapus = "<a class='dropdown-item bg-danger text-white' href='?hal=transaksi-respon$direkFree&id=$idtrans&mau=hapus&f=$foto&ingin=$ingin&idu=$iduser'>Hapus</a>";
                                    } 
                                   else 
                                   {
                                       $direkFree = "";
                               ...
                               elseif($ket=='Sedang diproses')
                               {
                                   ...
                                   $linkOK="<a class='dropdown-item bg-success text-white' href='?hal=transaksi-respon&id=$idtrans&mau=ok&ingin=$ingin&idt=$idT'>Ok</a>";
                               }
                               else
                               {
                                    $linkOK = "";
